  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`w-full md:max-w-[400px] xl:max-w-[600px] h-[90vh] md:h-screen bg-white flex flex-col ${
      ...
      >
        ...
        <div className="w-full flex-grow py-8 px-6 flex flex-col gap-4">
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-slate-700 text-xs md:text-sm xl:text-base font-medium">
                {size.dimensions}
              </p>
              <p className="text-slate-700 text-sm md:text-base xl:text-lg font-bold">
                {size.price} €
              </p>
            </div>
          </div>
        ...
        <div className="w-full p-4 flex flex-col gap-2">
          <button
            className="w-full py-2 px-4 bg-slate-800 rounded-lg shadow-lg flex justify-center items-center text-white text-sm md:text-base xl:text-lg font-bold
          ...
          <button
            className="w-full py-2 px-4 flex justify-center items-center rounded-lg border-[0.5px] border-slate-900 text-slate-700 text-sm md:text-base xl:text-lg font-medium
