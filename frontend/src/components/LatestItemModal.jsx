...
const LatestItemModal = ({ latestItem, setShowLatestItemModal }) => {
  ...
  return (
    <motion.div
      key={"overlay"}
      className="z-10 fixed inset-0 bg-black/50 flex justify-center items-end"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      <motion.div
        ...
        className="w-full h-[90vh] bg-white flex flex-col rounded-tl-lg rounded-tr-lg"
      >
        <div className="w-full p-4 bg-green-400 flex justify-center items-center gap-2 rounded-tl-lg rounded-tr-lg">
        ...
        <div className="w-full flex-grow py-8 px-6 flex flex-col gap-4">
          <div className="w-full flex justify-center items-center">
            <img className="w-auto max-h-[200px] object-contain" src={image} />
          </div>
